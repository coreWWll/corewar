...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2017/07/05 08:55:48 by dburtnja          #+#    #+#             */
/*   Updated: 2017/07/05 08:55:54 by dburtnja         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_car				*create_new_car(t_car *head, t_car *car, int delta,
									t_vm *main_struct);
...
void				put_int_on_map(t_vm *m_s, int data, char *players,
								char player_nbr);
