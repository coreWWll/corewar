...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2017/07/03 18:40:42 by dburtnja          #+#    #+#             */
/*   Updated: 2017/07/03 18:40:44 by dburtnja         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	do_st_func(t_vm *main_struct, t_car *car)
{
	...
	if (car->args[0].name == T_REG && car->args[0].value > 0 &&
		car->args[0].value <= 16 && car->args[1].name == T_REG &&
		car->args[1].value > 0 && car->args[1].value <= 16 && car->args_error)
	{
